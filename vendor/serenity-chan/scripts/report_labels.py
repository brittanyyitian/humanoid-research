...
DISPLAY_LABELS: dict[str, str] = {
    ...
    "CLEAR_DECISION_CANDIDATE": "明确决策对象",
    ...
    "FAILED": "失败",
    "FINAL_REPORT_READY": "正式报告就绪",
    "FALSE": "否",
    "FINANCIAL_CONSUMPTION_PARTIAL": "财务消费部分完成",
    "FINANCIAL_ROWS_NOT_CONSUMED": "财务行未被消费",
    "FINANCIALS": "财务数据",
    "FINANCIALS_REQUIRED_FOR_VALUATION_NORMALIZATION": "估值归一需要财务币种",
    ...
    "SINGLE_RESEARCH_OBJECT": "单一研究对象",
    "SINGLE_CANDIDATE": "单一研究对象",
    "SOURCE_DATA_UNAVAILABLE": "源数据不可用",
    "STALE": "过期",
    "STRONG_EXTENDED_WATCH": "强趋势延伸观察",
    "STRONG_OBSERVE": "强观察",
    "STRONG_PREFLIGHT": "强预检",
    "TARGET_FINANCIAL_CURRENCY_MISSING": "财务目标币种缺失",
    "RESEARCH_LEAD": "研究队列首位",
    "TRUE": "是",
    "UNKNOWN": "未知",
    "UNAVAILABLE": "不可用",
    "VALID": "有效",
    ...
    "VALUATION_CURRENCY_MISSING": "估值币种缺失",
...
DISPLAY_LABELS.update({
    "AI_RESEARCH": "AI 研究",
    "AI_DOSSIER_QUALITY_BLOCKED": "AI 深研质量未过闸",
    ...
    "LOCKUP_MONTHS": "锁定期（月）",
    "NEW_SHARES": "新增股份",
    "NO_FORMAL_DECISION_OBJECT": "不得输出正式决策对象",
    "NO_BUY_POINT": "无买点",
    "NOT_RUN": "未执行",
    ...
    "WATCHLIST": "观察名单",
    "WATCHLIST_READY": "观察名单就绪",
})


def display_label(value: Any, default: str = "", *, include_code: bool = False) -> str:
    if value is None:
        return default
